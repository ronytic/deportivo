...
class PDF extends FPDF{
	function Header(){
		...
		$this->Cell(190,4,utf8_decode("LISTADO DE ENCARGADOS"),0,5,"C");
		$this->ln(5);
		...
		$this->Cell(40,5,utf8_decode("Cargo"),1,0,"C");
		$this->Ln(5);
	}
	function Footer(){
		$this->SetY(-15);
...
$i=0;
foreach($encargado->mostrarTodo(0,"","Paterno,Materno,Nombres") as $m){
	$i++;
