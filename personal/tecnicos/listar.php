...
<div class="container_12" id="cuerpo">
  <div class=" prefix_2 grid_8 suffix_2">
    	<div class="titulo">Criterios de Listado de los Técnicos</div>
        <div class="cuerpo">
	...
	<div class="prefix_1 grid_10 suffix_1">
    	<div class="cuerpo" id="">
            ...
            <?php
			$i=0;
            foreach($tecnico->mostrarTodo(10) as $al){$i++;
				?>
                <tr class="contenido">
                	<td><?php echo $i;?></td>
                    ...
                    <td>
                    	<a href="modificar.php?Cod=<?php echo $al['CodTecnico']?>" class="botonSec corner-all modificar" rel="<?php echo $al['CodAlquiler']?>">Modificar</a>
                        <a href="eliminar.php?Cod=<?php echo $al['CodTecnico']?>" class="botonSec corner-all eliminar" rel="<?php echo $al['CodAlquiler']?>">Eliminar</a>
                    </td>
                </tr>
                <?php	
			}
